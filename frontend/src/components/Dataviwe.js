                            ...
                            <tbody>
                                {resData && resData.map((row , index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="text-black text-start">{row.Store_Item}</td>
                                        <td className="text-black text-start">{row.Item_Code}</td>
                                        <td className="text-black text-start">{row.Quantity}</td>
                                        <td className="text-black text-start">{row.InDate}</td>
                                        <td className="text-black text-start">{row.ExpireDate}</td>
